...
import com.submissionandroid.storyapp.databinding.ActivityLoginBinding
import com.submissionandroid.storyapp.view.ViewModelFactory
import com.submissionandroid.storyapp.view.main.MainActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun setupAction() {
        binding.loginButton.setOnClickListener {
            ...
            viewModel.login(email, password, onSuccess = { response ->
